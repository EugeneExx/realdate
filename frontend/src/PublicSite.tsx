  ...
  return (
    <DocumentPage title="Политика конфиденциальности" lead="Правила обработки и защиты персональных данных пользователей сайта.">
      ...
      <DocumentSection title="5. Доступ и передача данных">
        <p>Данные могут передаваться платёжному оператору ЮKassa, поставщику сообщений авторизации, хостинг-провайдеру и иным обработчикам только в объёме, необходимом для работы сервиса. Контакты одного участника передаются другому только при взаимной симпатии и в соответствии с выбранной пользователем функцией сервиса.</p>
  ...
  return (
    <DocumentPage title="Оплата и возврат" lead="Порядок внесения предоплаты, подтверждения участия и возврата денежных средств.">
      ...
      <DocumentSection title="Способы оплаты">
        <p>Онлайн-оплата принимается через защищённую платёжную страницу ЮKassa доступными для магазина способами, включая банковские карты или СБП. Платёжные реквизиты карты не передаются сайту REALDATE quickly.</p>
      ...
      <DocumentSection title="Чек самозанятого">
        <p>Исполнитель применяет налог на профессиональный доход. Электронный чек формируется в сервисе ФНС «Мой налог» и передаётся покупателю по указанным им контактам. Квитанция платёжного сервиса не заменяет чек самозанятого.</p>
      </DocumentSection>
      <DocumentSection title="Отказ участника">
        <p>Для отказа направьте заявление по электронной почте или в Telegram, указав ФИО, номер телефона, мероприятие и дату платежа. Возврат производится тем же способом, которым была внесена оплата, с учётом фактически понесённых и документально подтверждаемых расходов исполнителя.</p>
        <p>Требование рассматривается в срок, установленный законодательством, как правило, не более 10 календарных дней. Срок поступления денег после оформления возврата дополнительно зависит от банка плательщика.</p>
      </DocumentSection>
      <DocumentSection title="Отмена или перенос мероприятия">
        <p>При отмене мероприятия исполнителем оплата возвращается полностью. При переносе участнику предлагается новая дата; если она не подходит, участник вправе запросить возврат.</p>
      </DocumentSection>
    ...
    <DocumentPage title="Контакты и реквизиты" lead="Информация об организаторе мероприятий REALDATE quickly.">
      {!publicConfigReady && (
        <div className="document-warning">
          До подачи заявки в ЮKassa организатору необходимо заполнить ФИО, ИНН, адрес и электронную почту.
        </div>
      )}
